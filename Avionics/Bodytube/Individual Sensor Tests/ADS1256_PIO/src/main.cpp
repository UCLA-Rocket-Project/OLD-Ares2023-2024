//This code belongs to the ADS1256 library developed by Curious Scientist edited by Colin Skinner for Rocket Project use
...
void setup()
{
  Serial.begin(9600); //The value does not matter if you use an MCU with native USB
  ...
  Serial.print("PGA: ");
  Serial.println(A.readRegister(ADCON_REG));
  delay(100);
  //--
  Serial.print("MUX: ");
      ...
      case 'B': //Speed test
        {
          ...
          long numberOfSamples = 150; //Number of conversions
          long finishTime = 0;
          ...
          Serial.print("Total conversion time for 150 samples: ");
