...
namespace MS {
    ...
    // RP_MS5607 ms;
    // MS5611_SPI ms5607(HAL::ALTIMETER2_CS, HAL::HMOSI_PIN, HAL::HMISO_PIN, HAL::HSCK_PIN);
    MS5611_SPI ms5607(HAL::ALTIMETER2_CS, HAL::sensorSPI);
    
    uint32_t start, stop;

    const float SEALEVELPRESSURE_HPA = 1018.90; // Sea level pressure of LA 
